...
\titulo{
    Reflexões acerca do gap entre a formação e capacitação de professores para lidar com alunos com deficiência e a realidade da inclusão nas escolas
}%
...
\orientador{Regina Fátima Cury {}Azevedo}%
%\coorientador{}%
\instituicao{Universidade Estácio de Sá}%

\preambulo{
	Trabalho apresentada à professora Regina Fátima Cury Azevedo como requisito parcial para obtenção da aprovação na disciplina Educação Especial (CEL1694-3734363) 9004.
}
...
\chapter{Objetivos}
	Verificar como as escolas estão se adequando na estrutura, como esta sendoo conteúdo aplicado e também quais são os maiores desafios enfrentados no dia a dia.
		
\chapter{Introdução}
	Conforme definição escrita em \citeaa{Aranha2004}
	\begin{citacao}
		\textbf{Escola inclusiva }é, aquela que garante a qualidade de ensino educacional
		...
		idade, deficiência, condição social ou qualquer outra situação. Um ensino significativo,
		é aquele que garante o acesso ao conjunto sistematizado de conhecimentos
...
\chapter{Resultados}
	...
	\textbf{\textit{"Aceitação da família, falta de recursos financeiros, adaptação de material físico(mobiliários escolares), acessibilidade na escola(rampa, bebedouros adaptados, banheiros, brinquedos), outros"}}
	
	\subsection{Por outro lado}
	
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.9\linewidth]{figuras/screenshot001}
		\caption{}
		\label{fig:screenshot001}
	\end{figure}
	
	
	Entretanto, como destacado na reportagem do Jornal de Minas exposto por \citeaa{Minas2019} no seu canal de youtube em \url{https://www.youtube.com/watch?v=uWqs1CxsOc0} é nítido que ainda não temos a cultura da inclusão.  
	
	Os pais terem que procurar escola que inclua seu filho, independente de sua necessidade, não deveria ser um problema, principalmente para as classes mais necessitadas.
	
	Complemento com esse relato extraído de \citeaa{SouzaTrindade2004}
	
	\begin{citacao}
		É deste acolhimento que as mães sentem falta, fato notável no desabafo de Lurdinha: 
		
		\textit{“somente carinho era o que eu precisava naquela hora. As informações secas não acolhem.
		Claro que são necessárias; todavia, são úteis apenas quando se fazem apresentar num clima
		afetuoso de acolhimento”}
	\end{citacao}	

\section{Conclusão}		
	
	Na minha visão, ver os dois extremos aqui expostos, entre ter um profissional capacitado e pronto para receber um aluno especial e a dificuldades de mães e pais de matricular os filhos, me aponta um gap, um abismo no tocante a inclusão de alunos especiais no pais.
	
	Termino com a reflexão de \citeaa{Souza2018}
